...
export default defineConfig({
                ...
                S.list()
                  ...
                  .items([
                    ...
                    S.listItem()
                      ...
                      .child(S.document().schemaType('dembiDolloPage').documentId('dembiDolloPage')),
                  ])
              ),
  ...
  document: {
    ...
    actions: (prev, context) => {
      const singletonTypes = ['homePage', 'aboutPage', 'staffPage', 'galleryPage', 'contactPage', 'dembiDolloPage', 'siteSettings'];
