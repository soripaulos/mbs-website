 ...
 * @category Functions Types
 */
export type BlueprintScheduledFunctionResourceEvent = BlueprintScheduledFunctionExplicitResourceEvent | BlueprintScheduledFunctionExpressionResourceEvent;
/**
 * Union type of all function resource event configurations
 * @category Functions Types
 */
export type BlueprintFunctionResourceEvent = BlueprintDocumentFunctionResourceEvent | BlueprintMediaLibraryFunctionResourceEvent | BlueprintScheduledFunctionResourceEvent | BlueprintSyncTagInvalidateFunctionResourceEvent;
/**
